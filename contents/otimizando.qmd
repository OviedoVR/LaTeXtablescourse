...
![](C:\Users\vinic\Documents\LaTeX-tables\Conteudo-LaTeX-tables\assets\processo-criar-tabela.png){width=100%}

## Exemplo (LaTeX tables generator)

Reproduza a tabela a seguir, fazendo uso de ferramentas auxiliares:

![](C:\Users\vinic\Documents\LaTeX-tables\Conteudo-LaTeX-tables\assets\LaTeXtablesGen.png){width=70%}
